...
<div class="wrapper">
		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <form id="registration-form" action="<?php echo base_url();?>add_process" method="post" onsubmit="return validateForm();">
...
<button type="submit" class="btn btn-primary btn-outline-primary badge-pill btn-block w-75 m-auto">ADD</button>
</form>		
